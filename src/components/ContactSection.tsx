    ...
    <section id="contato" className="py-24 bg-gradient-to-b from-white to-[#faf9f6]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                {WHATSAPP_NUMBERS.map((num, idx) => (
                  ...
                  >
                    <div className="w-11 h-11 rounded-lg bg-gold-500 text-white flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
                      <MessageCircle className="w-5 h-5" />
                    </div>
                    <div>
                      <p className="text-xs font-semibold text-gold-800 uppercase tracking-wider">
                ...
                <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 border border-gray-100">
                  <div className="w-11 h-11 rounded-lg bg-gray-200 text-gray-700 flex items-center justify-center flex-shrink-0">
          ...
          {/* Interactive Form */}
          <div className="lg:col-span-7 bg-white p-8 sm:p-10 rounded-2xl border border-gold-200/70 shadow-card">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-gold-500 focus:ring-2 focus:ring-gold-200 outline-none text-sm text-gray-900 placeholder:text-gray-400 transition-all"
                  />
                </div>
              ...
              <div>
                <label htmlFor="projectType" className="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-2">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-gold-500 focus:ring-2 focus:ring-gold-200 outline-none text-sm text-gray-900 bg-white transition-all"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-gold-500 focus:ring-2 focus:ring-gold-200 outline-none text-sm text-gray-900 placeholder:text-gray-400 transition-all resize-none"
                ></textarea>
              </div>

              <button
                type="submit"
                className="w-full inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-base font-bold text-white bg-brand-black hover:bg-gold-600 transition-all duration-300 shadow-md hover:shadow-gold hover:-translate-y-0.5"
              >
