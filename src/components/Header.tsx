    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <button
          ...
          className="md:hidden p-2 rounded-lg text-gray-700 hover:text-gold-600 hover:bg-gray-100 focus:outline-none"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-b border-gray-100 shadow-xl px-6 py-6 transition-all animate-in fade-in slide-in-from-top-2">
