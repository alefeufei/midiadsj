      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-gold-200/80 shadow-card flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gold-50 border border-gold-200 text-gold-800 text-sm font-bold mb-4">
            ...
            <div className="flex flex-wrap gap-2.5 sm:gap-3 mb-6">
              {toolsList.map((tool, idx) => {
                ...
                return (
                  <span
                    key={idx}
                    className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gray-50/90 border border-gray-200/80 text-sm sm:text-base font-semibold text-gray-800 hover:border-gold-300 hover:bg-gold-50/40 hover:text-gold-900 transition-all duration-200 shadow-2xs"
                  >
          ...
          <div className="flex-shrink-0 w-full lg:w-auto text-center">
            <Link
              href="/ferramentas"
              className="inline-flex items-center justify-center gap-3 w-full sm:w-auto px-8 py-4 rounded-xl text-base sm:text-lg font-bold text-white bg-brand-black hover:bg-gold-600 transition-all duration-300 shadow-md hover:shadow-gold hover:-translate-y-0.5 group"
            >
              <Wrench className="w-5 h-5 text-gold-400 group-hover:text-white transition-colors flex-shrink-0" />
